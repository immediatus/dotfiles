...
distrobox enter dev-workspace -- sh -c 'ln -sfn "/run/host/var/home/'"${USER}"'/Downloads" ~/Downloads 2>/dev/null || mkdir -p ~/Downloads'
distrobox enter dev-workspace -- sh -c 'ln -sfn "/run/host/var/home/'"${USER}"'/Documents" ~/Documents 2>/dev/null || mkdir -p ~/Documents'
distrobox enter dev-workspace -- sh -c 'ln -sfn "/run/host/var/home/'"${USER}"'/Music" ~/Music 2>/dev/null || mkdir -p ~/Music'
distrobox enter dev-workspace -- sh -c 'ln -sfn "/run/host/var/home/'"${USER}"'/Pictures" ~/Pictures 2>/dev/null || mkdir -p ~/Pictures'
